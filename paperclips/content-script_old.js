...
function MakePaperclip(){
	...
	function doWork(){
		...
		var display = wireBuyerDiv.style['display'];
		
		if(vClipmakerRate.length < 3 || display != 'none')){
			if (vClipmakerRate.length < 3 && !btnMakePaperclip.disabled)
